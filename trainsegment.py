...
def main():
    ...
    train_loader, val_loader = get_loaders_segmentation(args.train_files, args.train_masks, args.val_files, args.val_masks, IMAGE_HEIGHT, IMAGE_WIDTH, args.batchsize)
